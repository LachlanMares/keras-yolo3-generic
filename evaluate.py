...
def _main_(args):
    ...
    ###############################  
    eval_ints, labels = parse_voc_annotation(
        config['evaluate']['eval_annot_folder'],
        config['evaluate']['eval_image_folder'],
    ...
    average_precisions = evaluate(infer_model, eval_generator)
